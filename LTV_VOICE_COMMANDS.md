...
|--------|----|-------------|--------|
| `remove display` | 114 | `HudClearDisplayRequested` | Hides the HUD |
...
work in the LTV scene. HUD visibility is **voice-only** — the open-palm gesture that used to
toggle it was disabled because incidental palm poses were hiding the HUD unprompted.
